...
public class App {
	public static void main(String[] args) {
		...
		Film film6 = new Film("Harry Potter and the Philosophers Stone", 152, "November 10 2001", "JK Rowling");
		...
		Film film9 = new Film("Harry Potter and the Half-Blood Prince", 153, "July 15 2009", "JK Rowling");
		...
		// Stream<Film> filmStream = Stream.of(film1, film2, film3, film4, film5,
		// film6);
		...
		Stream<Film> nolanFilms = filmStream3.filter(Film -> Film.getFilmCreator() == "Christopher Nolan");
